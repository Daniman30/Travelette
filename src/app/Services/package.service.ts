...
import { IApiCreatePackage, IApiListPackage } from './Models/listAgency.interface';
...
export class PackageService {
    ...
    listPackages() {
        return this.httpClient.get<IApiListPackage[]>('http://localhost:5094/api/Package/list')
    }
